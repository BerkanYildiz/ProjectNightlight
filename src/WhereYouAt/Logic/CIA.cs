    ...
    internal class CIA
    {
        internal void Locate(string PersonName)
        {
            ...
            GeoWatcher.PositionChanged += (Sender, Args) =>
            {
                ...
                var Latitude = CurrentLocation.Latitude.ToString("0.0000000000");
                var Longitude = CurrentLocation.Longitude.ToString("0.0000000000");
            ...
            if (!GeoWatcher.TryStart(false, TimeSpan.FromSeconds(10)))
            {
